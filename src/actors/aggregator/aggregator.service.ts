...
import { UpdateAggregatorProfileDto } from './dto/update-profile.dto';
...
export class AggregatorService {
  ...
  async updateProfile(userId: number, dto: UpdateAggregatorProfileDto) {
    ...
    const { profile_picture_id, ...metaFields } = dto;
